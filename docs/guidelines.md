...
We’re excited to showcase a growing set of scripts and tools developed by FAIRe implementors! It’s fantastic to see more groups adopting the FAIRe guidelines and building automation tools to streamline their workflows. We are currently developing these tools in both R and Python as part of a new package – stay tuned via [FAIRe Coding](https://fair-edna.github.io/update.html#faire-coding) on the News & Updates page!

*If your community has developed FAIRe-related tools, please [contact us](https://fair-edna.github.io/contact.html) – we’d love to connect and explore collaboration opportunities! 

-	[**FAIReSheets**](https://github.com/aomlomics/fairesheets) (FAIR eDNA template generator for Google Sheets): This python script creates the FAIRe eDNA Data Template in Google Sheets. It replicates the template creation from the [FAIRe-ator](https://github.com/FAIR-eDNA/FAIRe-ator/blob/main), except FAIReSheets outputs the template to Google Sheets rather than a Microsoft Excel spreadsheet. Developed by Bayden Willms ([ORCID](https://orcid.org/0009-0003-2751-7317)/ [GitHub](https://github.com/baydenwillms)) at [NOAA AOML 'Omics](https://github.com/aomlomics)
-	[**FAIRe2NCBI**](https://github.com/aomlomics/FAIRe2NCBI) : A python script to convert FAIRe metadata sheets (NOAA format) to NCBI BioSample and SRA submission templates with automated configuration management. Developed by Clément Coclet ([ORCID](https://orcid.org/0000-0002-6672-148X))at [NOAA AOML 'Omics](https://github.com/aomlomics)
-	[**FAIRe2QIIME**](https://github.com/aomlomics/faire2qiime) : This python script converts NOAA FAIRe Excel metadata into QIIME2-compatible metadata and manifest files for downstream analysis. Developed by Luke Thompson ([ORCID](https://orcid.org/0000-0002-3911-1280)/ [GitHub](https://github.com/lukenoaa)), Katherine Silliman ([ORCID](https://orcid.org/0000-0001-5964-3965)/ [GitHub](https://github.com/ksilnoaa)) at [NOAA AOML 'Omics](https://github.com/aomlomics)
-	[**edna2obis**](https://github.com/aomlomics/edna2obis) : This python script converts eDNA datasets (supporting both generic FAIRe eDNA data format and FAIRe NOAA format) into a Darwin Core archive to OBIS submission. Developed by Bayden Willms ([ORCID](https://orcid.org/0009-0003-2751-7317)/ [GitHub](https://github.com/baydenwillms)), Katherine Silliman ([ORCID](https://orcid.org/0000-0001-5964-3965)/ [GitHub](https://github.com/ksilnoaa)) at [NOAA AOML 'Omics](https://github.com/aomlomics)
-	[**FAIRe2ENA**](https://github.com/Minderoo-OceanOmics-Centre-UWA/FAIRe2ENA) : Convert FAIRe-formatted metadata to ENA (European Nucleotide Archive) XML format for submission. Developed by Philipp Bayer ([ORCID](https://orcid.org/0000-0001-8530-3067)/ [GitHub](https://github.com/philippbayer)) at [Minderoo Foundation OceanOmics](https://github.com/Minderoo-OceanOmics-Centre-UWA)
-	[**Amplicon Nextflow**](https://github.com/MinderooFoundation/OceanOmics-amplicon-nf) : A bioinformatics pipeline for quality controls, denoising, ASVs and ZOTUs, taxonomic assignment, with an option to use FAIRe metadata as an input and output. Developed by Adam Bennett ([GitHub](https://github.com/a4000)), Philipp Bayer ([ORCID](https://orcid.org/0000-0001-8530-3067)/ [GitHub](https://github.com/philippbayer)), Sebastian Rauschert ([ORCID](https://orcid.org/0000-0001-8359-6898)/ [GitHub](https://github.com/sebrauschert) at [Minderoo Foundation OceanOmics](https://github.com/Minderoo-OceanOmics-Centre-UWA) 
