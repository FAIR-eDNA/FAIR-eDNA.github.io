...
In this section, we outline the various data components and formats, present a comprehensive FAIR eDNA (FAIRe) metadata checklist (click [here](/FAIRe_checklist_v1.0.xlsx) to download) along with scripts and tools to guide users through the data formatting process. 
